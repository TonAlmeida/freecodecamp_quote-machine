...
class QuoteBox extends React.Component {
    ...
    getQuote() {
        const min = 0,
            n = (Math.random() * (this.quotesArray.length - min) + min).toFixed(0),
            m = (Math.random() * (this.colors.length - min) + min).toFixed(0)
        this.setState({
            quote: this.quotesArray[n],
            color: this.colors[m]
        })
    }
    ...
    render() {
        return (
            <div className={styles.background} style={{backgroundColor: this.state.color}} id="background">
                <div className={styles.quoteBox} id="quote-box">
                    <div className={styles.containerTexts} >
                        ...
                        <div className={styles.author} id="author">
                            <p style={{color: this.state.color}}>-{this.state.quote.author}</p>
                        </div> 
                    </div>
                </div>
                <div className={styles.containerButtons}>
                    <button onClick={this.reloadPage} style={{backgroundColor: this.state.color}} className={styles.newQuote} id="new-quote">
                        Next
                    </button>
                    <div>
                        <a href="twitter.com/intent/tweet" target="_blank" id="tweet-quote">
                            <button className={styles.tweetQuote} style={{backgroundColor: this.state.color}} >
                                twitt
                            </button>
                        </a>
                        <a href="twitter.com/intent/tweet" target="_blank" id="tweet-quote">
